 ...
 */
export const fixListOfWagons=([first, second, ...rest])=>[...rest, first, second];
 ...
 */
export const correctListOfWagons=([designatedLocomotive, ...rest],missingWagons)=>[designatedLocomotive, ...missingWagons, ...rest];
 ...
 */
export const extendRouteInformation=(route ,moreRouteInformation)=> ({...route, ...moreRouteInformation});
