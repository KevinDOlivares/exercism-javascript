 ...
 */
export const getSecondCard = ([first,second]) => second;
 ...
 */
export const swapTwoCards=([seventh,tenth])=>[tenth,seventh];
 ...
 */
export const shiftThreeCardsAround=([sixth, tenth, second])=>[tenth, second, sixth];
